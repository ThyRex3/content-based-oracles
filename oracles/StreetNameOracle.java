...
public class StreetNameOracle implements Oracle, AlterDatabase  {
  private int ml,  //Maximum length.
              gid;  //Grouping ID.
  private double mp,  //Minimum percentage.
                 mbp;  //Maximum blank percentage.
  private Lookup lookup;  //The data structure containing the database.
  ...
  public StreetNameOracle( )  {  }  /*  Constructor  */
  ...
  public void initialize( OracleGroup og, String[] args )  {
    ...
    this.og = og;
    on = "street name";
    nfn = "/data/StreetNames_Top800.dat";
    xfn = "/data/StreetNames_Top50000.dat";
